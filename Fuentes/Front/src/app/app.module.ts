...
@NgModule({
  declarations: [
    ...
    AutenticarusuariosComponent, SeguimientoComponent, VerdiagnosticoComponent, VerasesoriaComponent, VerevaluacionComponent, ReporteComponent, ConvocatoriaComponent   
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
